...
var checkpoints__contains = map[string]map[string]any{
	"loader.go": map[string]any{
		...
		`5:9:.test.1 $(contains a,$(val)) {5:12:delegate {5:14:builtin contains} {=list {5:23:word a}} {=list {5:25:delegate {3:5:def val}}}}`:`{} {5:12:null}`,
		`6:9:.test.2 $(contains x b c,$(val)) {6:12:delegate {6:14:builtin contains} {=list {6:23:word x} {6:25:word b} {6:27:word c}} {=list {6:29:delegate {3:5:def val}}}}`:`{} {6:12:null}`,
