...
var checkpoints_match = map[string]any{
	...
	`b?r/v?.h v1.h`:`false [] []`,
	`b?r/v?.h v2.h`:`false [] []`,
	`b?r/v?.h xv1y.h`:`false [] []`,
	`b?r/v?.h xv22y.h`:`false [] []`,
	`b?r/v?.h xv333y.h`:`false [] []`,
	`bar/*.hh v1.h`:`false [] []`,
	`bar/*.hh v2.h`:`false [] []`,
	`bar/*.hh xv1y.h`:`false [] []`,
	...
	`f*?/x.h foo/b?r/v?.h`:`false [foo b?r v?.h] [oo/b?r/v?.h]`,
	`f*?/x.h foo/**/x.h`:`false [foo ** x.h] [oo/**/x.h]`,
	`f*?/x.h fo?/**/x.h`:`false [fo? ** x.h] [o?/**/x.h]`,
	`fo? foo`:`true foo [o]`,
	`fo?/**/x.h f*?/x.h`:`false [] []`,
	...
	`foo/*.h foo/bar/*.h`:`false [foo] []`,
	`foo/*.h foo/bar/v1.h`:`false [foo] []`,
	`foo/*.h foo/bar/v2.h`:`false [foo] []`,
	`foo/*.h foo/bar/v?.h`:`false [foo] []`,
	`foo/*.h foo/bar/zz/x.h`:`false [foo] []`,
	`foo/*.h foo/bar/zz/?.h`:`false [foo] []`,
	`foo/*.h foo/bar/*/*.h`:`false [foo] []`,
	`foo/*.h foo/bar/z?/?.h`:`false [foo] []`,
	`foo/b?r/v?.h f*?/x.h`:`false [] []`,
	`foo/b?r/v?.h foo/b*/v*.h`:`false [foo] []`,
	...
	`foo/b*/v*.h foo/**/x.h`:`false [foo] []`,
	`foo/b*/v*.h fo?/**/x.h`:`false [] []`,
	`foo/bar/*.h foo/*.h`:`false [foo] []`,
	`foo/bar/*.h foo/**.hh`:`false [foo] []`,
	`foo/bar/*.h foo???/x.h`:`false [] []`,
	...
	`foo/bar/z?/?.h foo???/x.h`:`false [] []`,
	`foo/bar/z?/?.h foo/*.h`:`false [foo] []`,
	`foo/bar/z?/?.h foo/bar/zz/x.h`:`true [foo bar zz x.h] [z x]`,
	`foo/bar/zz/?.h foo/*.h`:`false [foo] []`,
	`foo/bar/zz/?.h foo/bar/zz/x.h`:`true [foo bar zz x.h] [x]`,
	`foo/bar/zz/?.h foo???/x.h`:`false [] []`,
