...
func (*plainint) check_evaluate(_ Context, _, _ []Value, _ *plain) {}
func (*execution) check_evaluate(Context, interpreter, []Value, Value) {}
...
func (*exec_ctx) exec_check(int, *raw, error) {}
...
func (p *compiler) check_ident(*ident_ctx, Context, Value, string, Symbol) {}
func (p *compiler) check_sources(Context, Symbol) func(*[]Symbol) { return nil }
func (p *compiler) check_assign(Context, Value, Symbol) func(**def) { return nil }
