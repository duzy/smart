...
var checkpoints__wildcard = map[string]map[string]any{
	"loader.go": map[string]any{
		...
		`$/ {4:39:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {4:39 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),

		`7:5:top $/ {7:8:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {7:8 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),
		`8:5:inc $/ {8:8:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {8:8 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),

		`17:6:val1 $/ {17:32:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {17:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),
		...
		`18:6:val2 $/ {18:32:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {18:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),
		...
		`19:6:val3 $/ {19:32:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {19:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),
		...
		`26:6:fix3 $/ {26:32:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {26:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),
		...
		`27:6:fix4 $/ {27:32:delegate {1:1:def /}}`:testdata_f(`%[1]s/builtins/wildcard {27:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}}`),
...
var checkstrs__wildcard = map[string]map[string]any{
	"loader.go": map[string]any{
		`17:6:val1 $/ {17:32:delegate {1:1:def /}}`:testdata_f(`{17:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}} %[1]s/builtins/wildcard`),
		`18:6:val2 $/ {18:32:delegate {1:1:def /}}`:testdata_f(`{18:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}} %[1]s/builtins/wildcard`),
		`19:6:val3 $/ {19:32:delegate {1:1:def /}}`:testdata_f(`{19:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}} %[1]s/builtins/wildcard`),
		`26:6:fix3 $/ {26:32:delegate {1:1:def /}}`:testdata_f(`{26:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}} %[1]s/builtins/wildcard`),
		`27:6:fix4 $/ {27:32:delegate {1:1:def /}}`:testdata_f(`{27:32 {=path %[3]s {1:1:word builtins} {1:1:word wildcard}}} %[1]s/builtins/wildcard`),
	},
}
