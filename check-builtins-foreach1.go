...
var checkpoints__foreach1 = map[string]map[string]any{
	...
	"check-builtins-foreach1_test.go": map[string]any{
		`21 $1 {6:21:delegate {4:16:auto 1}}`:`{} {6:21 {4:16:null}}`,
		`21 $1 {4:15:delegate {4:16:auto 1}}`:`{} {4:15 {6:21 {4:16:null}}}`,
		`21 $2 {4:18:delegate {4:19:auto 2}}`:`B b {=list {4:18 {6:24:word B}} {4:18 {6:26:word b}}}`,
		...
		`21 &(.test.s) {3:11:closure {=compound {3:13:punct .} {3:14:word test} {3:18:punct .} {3:19:word s}}}`:`foo {3:11 {8:16:word foo}}`,
		`21 &(.test.s) {3:36:closure {=compound {3:38:punct .} {3:39:word test} {3:43:punct .} {3:44:word s}}}`:`foo {3:36 {8:16:word foo}}`,
		`21 $(value .test~&(.test.s)) {3:22:delegate {3:24:builtin value} {=list {=compound {3:30:punct .} {3:31:word test} {3:35:punct ~} {3:36:closure {=compound {3:38:punct .} {3:39:word test} {3:43:punct .} {3:44:word s}}}}}}`:`test-foo {3:22 {=compound {14:16:word test} {=flag {14:21:word foo}}}}`,

		`21 $_ {4:29:delegate {4:30:auto _}}`:[]string{`B {4:29 {4:18 {6:24:word B}}}`,`b {4:29 {4:18 {6:26:word b}}}`},
		...
		`21 &(.test.$_) {4:21:closure {=compound {4:23:punct .} {4:24:word test} {4:28:punct .} {4:29:delegate {4:30:auto _}}}}`:[]string{
			`test-B {4:21 {=compound {12:16:word test} {=flag {12:21:word B}}}}`,
			`test-b {4:21 {=compound {13:16:word test} {=flag {13:21:word b}}}}`,
		},
		...
		`21 &(.test.s) {4:41:closure {=compound {4:43:punct .} {4:44:word test} {4:48:punct .} {4:49:word s}}}`:`foo {4:41 {8:16:word foo}}`,

		`21 $_ {4:52:delegate {4:30:auto _}}`:[]string{`B {4:52 {4:18 {6:24:word B}}}`,`b {4:52 {4:18 {6:26:word b}}}`},
		...
		`21 &(.test~&(.test.s).$_) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {=compound {4:43:punct .} {4:44:word test} {4:48:punct .} {4:49:word s}}} {4:51:punct .} {4:52:delegate {4:30:auto _}}}}`:[]string{
			`test-foo-B {4:33 {=compound {17:16:word test} {=flag {=compound {17:21:word foo} {=flag {17:25:word B}}}}}}`,
			`test-foo-b {4:33 {=compound {18:16:word test} {=flag {=compound {18:21:word foo} {=flag {18:25:word b}}}}}}`,
		},
		...
		`23 6:9:.test.1 &(.test.s) {3:11:closure {=compound {3:13:punct .} {3:14:word test} {3:18:punct .} {3:19:word s}}}`:`&(.test.s) {3:11:closure {8:13:def .test.s}}`,
		...
		`23 6:9:.test.1 &(.test.s) {3:36:closure {=compound {3:38:punct .} {3:39:word test} {3:43:punct .} {3:44:word s}}}`:`foo {3:36 {8:16:word foo}}`,
		`23 6:9:.test.1 $(value .test~&(.test.s)) {3:22:delegate {3:24:builtin value} {=list {=compound {3:30:punct .} {3:31:word test} {3:35:punct ~} {3:36:closure {=compound {3:38:punct .} {3:39:word test} {3:43:punct .} {3:44:word s}}}}}}`:`test-foo {3:22 {=compound {14:16:word test} {=flag {14:21:word foo}}}}`,

		`23 6:9:.test.1 $1 {4:15:delegate {4:16:auto 1}}`:`a {4:15 {6:21 {1:9:word a}}}`,
		`23 6:9:.test.1 $2 {4:18:delegate {4:19:auto 2}}`:`B b {=list {4:18 {6:24:word B}} {4:18 {6:26:word b}}}`,
		`23 6:9:.test.1 $_ {4:29:delegate {4:30:auto _}}`:[]string{
			`a {4:29 {4:15 {6:21 {1:9:word a}}}}`,
			`B {4:29 {4:18 {6:24:word B}}}`,
			`b {4:29 {4:18 {6:26:word b}}}`,
		},
		...
		`23 6:9:.test.1 &(.test.$_) {4:21:closure {=compound {4:23:punct .} {4:24:word test} {4:28:punct .} {4:29:delegate {4:30:auto _}}}}`:[]string{
			`&(.test.a) {4:21:closure {11:13:def .test.a}}`,
			`&(.test.B) {4:21:closure {12:13:def .test.B}}`,
			`&(.test.b) {4:21:closure {13:13:def .test.b}}`,
		},
		...
		`23 6:9:.test.1 &(.test.s) {4:41:closure {=compound {4:43:punct .} {4:44:word test} {4:48:punct .} {4:49:word s}}}`:`&(.test.s) {4:41:closure {8:13:def .test.s}}`,

		`23 6:9:.test.1 $_ {4:52:delegate {4:30:auto _}}`:[]string{
			`a {4:52 {4:15 {6:21 {1:9:word a}}}}`,
			`B {4:52 {4:18 {6:24:word B}}}`,
			`b {4:29 {4:18 {6:26:word b}}}`,
			`b {4:52 {4:18 {6:26:word b}}}`,
		},
		...
		`23 6:9:.test.1 &(.test~&(.test.s).$_) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {=compound {4:43:punct .} {4:44:word test} {4:48:punct .} {4:49:word s}}} {4:51:punct .} {4:52:delegate {4:30:auto _}}}}`:[]string{
			`&(.test~&(.test.s).a) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {8:13:def .test.s}} {4:51:punct .} {4:52 {4:15 {6:21 {1:9:word a}}}}}}`,
			`&(.test~&(.test.s).B) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {8:13:def .test.s}} {4:51:punct .} {4:52 {4:18 {6:24:word B}}}}}`,
			`&(.test~&(.test.s).b) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {8:13:def .test.s}} {4:51:punct .} {4:52 {4:18 {6:26:word b}}}}}`,
		},
		...
		`27 &(.test~&(.test.s).a) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {8:13:def .test.s}} {4:51:punct .} {4:52 {4:15 {6:21 {1:9:word a}}}}}}`:`test-foo-a {4:33 {=compound {16:16:word test} {=flag {=compound {16:21:word foo} {=flag {16:25:word a}}}}}}`,

		`27 test-B {=compound {12:16:word test} {=flag {12:21:word B}}}`:`test-B {=compound {12:16:word test} {=flag {12:21:word B}}}`,
		`27 &(.test.B) {4:21:closure {12:13:def .test.B}}`:`test-B {4:21 {=compound {12:16:word test} {=flag {12:21:word B}}}}`,
		...
		`27 &(.test~&(.test.s).B) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {8:13:def .test.s}} {4:51:punct .} {4:52 {4:18 {6:24:word B}}}}}`:`test-foo-B {4:33 {=compound {17:16:word test} {=flag {=compound {17:21:word foo} {=flag {17:25:word B}}}}}}`,

		`27 test-b {=compound {13:16:word test} {=flag {13:21:word b}}}`:`test-b {=compound {13:16:word test} {=flag {13:21:word b}}}`,
		`27 &(.test.b) {4:21:closure {13:13:def .test.b}}`:`test-b {4:21 {=compound {13:16:word test} {=flag {13:21:word b}}}}`,
		...
		`27 &(.test~&(.test.s).b) {4:33:closure {=compound {4:35:punct .} {4:36:word test} {4:40:punct ~} {4:41:closure {8:13:def .test.s}} {4:51:punct .} {4:52 {4:18 {6:26:word b}}}}}`:`test-foo-b {4:33 {=compound {18:16:word test} {=flag {=compound {18:21:word foo} {=flag {18:25:word b}}}}}}`,
	},
}
