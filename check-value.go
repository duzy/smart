...
var checkpoints_value = map[string]map[string]any{
	"loader.go": map[string]any{
		`1120 42:7:val5 $(quote a\,b\,c,x\,y\,z) {42:10:delegate {42:12:builtin quote} {=list {=compound {42:18:word a} {42:19:escaped \,} {42:21:word b} {42:22:escaped \,} {42:24:word c}}} {=list {=compound {42:26:word x} {42:27:escaped \,} {42:29:word y} {42:30:escaped \,} {42:32:word z}}}}`:`{42:12:builtin quote} {=quote a\,b\,c x\,y\,z} {42:10 {=quote {=list {=compound {42:18:word a} {42:19:escaped \,} {42:21:word b} {42:22:escaped \,} {42:24:word c}}} {=list {=compound {42:26:word x} {42:27:escaped \,} {42:29:word y} {42:30:escaped \,} {42:32:word z}}}}}`,
		`1120 15:8:cond13 &(something) {15:12:closure {15:14:word something}}`:`{15:14:word something} &(something) {15:12:closure {15:14:word something}}`,
		`1120 55:11:conf0 $@ {55:19:delegate {55:11:def @}}`:`{55:11:def @} conf0 {55:19 {55:11:word conf0}}`,
		`1120 59:11:conf3 $@ {59:29:delegate {59:11:def @}}`:`{59:11:def @} conf3 {59:29 {59:11:word conf3}}`,
		`1120 59:11:conf3 $< {59:33:delegate {1:1:def <}}`:`{1:1:def <} foo {59:33 {59:19:word foo}}`,
		`1120 59:11:conf3 $> {59:36:delegate {1:1:def >}}`:`{1:1:def >} bar {59:36 {59:23:word bar}}`,
		`1120 59:11:conf3 $^ {59:40:delegate {1:1:def ^}}`:`{1:1:def ^} foo bar {=list {59:40 {59:19:word foo}} {59:40 {59:23:word bar}}}`,
		`1120 56:11:conf1 $/ {56:48:delegate {1:1:def /}}`:sfmt(`{1:1:def /} %[1]s/value {56:48 {=path %[2]s {1:1:word value}}}`,testdata_dir,testdata_ts),
		`1120 57:11:conf2 $/ {57:97:delegate {1:1:def /}}`:sfmt(`{1:1:def /} %[1]s/value {57:97 {=path %[2]s {1:1:word value}}}`,testdata_dir,testdata_ts),
		`1120 56:11:conf1 $0 {56:45:delegate {56:46:auto 0}}`:ssfmt([]string{
		...
		`1120 56:11:conf1 $(grep {=regex ^.+?\.o$$},$0,$//test.txt) {56:19:delegate {56:21:builtin grep} {=list {56:34:regex ^.+?\.o$}} {=list {56:45:delegate {56:46:auto 0}}} {=list {=path {56:48:delegate {1:1:def /}} {=compound {56:51:word test} {56:55:punct .} {56:56:word txt}}}}}`:`{56:21:builtin grep}`+
			sfmt(` foo.o foo-x.o foo-x-y.o foo-x-y-z.o foobar.o {=list `+
				...
				`{56:19 {56:45 {%[1]s/value/test.txt:5:1:raw foobar.o}}}}`,testdata_dir),
		`1120 57:11:conf2 $(grep {=regex ^(.+?)((-(?P<i>.+?))*)(\.)(?P<x>o)$$},$0 $1 $2 $3 $(i) $5 $(x),$//test.txt) {57:19:delegate {57:21:builtin grep} {=list {57:34:regex ^(.+?)((-(?P<i>.+?))*)(\.)(?P<x>o)$}} {=list {57:72:delegate {56:46:auto 0}} {57:75:delegate {19:21:auto 1}} {57:78:delegate {57:79:auto 2}} {57:81:delegate {57:82:auto 3}} {57:84:delegate {57:86:auto i}} {57:89:delegate {57:90:auto 5}} {57:92:delegate {57:94:auto x}}} {=list {=path {57:97:delegate {1:1:def /}} {=compound {57:100:word test} {57:104:punct .} {57:105:word txt}}}}}`:`{57:21:builtin grep}`+
			sfmt(` foo.o foo . o foo-x.o foo -x -x x . o foo-x-y.o foo -x-y -y y . o foo-x-y-z.o foo -x-y-z -z z . o foobar.o foobar . o {=list `+
				...
				`{57:19 {57:92 {%[1]s/value/test.txt:5:8:raw o}}}}`,testdata_dir),
		`1120 57:11:conf2 $0 {57:72:delegate {56:46:auto 0}}`:ssfmt([]string{
		...
		`1120 57:11:conf2 $1 {57:75:delegate {19:21:auto 1}}`:ssfmt([]string{
		...
		`1120 57:11:conf2 $2 {57:78:delegate {57:79:auto 2}}`:ssfmt([]string{
		...
		`1120 57:11:conf2 $3 {57:81:delegate {57:82:auto 3}}`:ssfmt([]string{
		...
		`1120 57:11:conf2 $(i) {57:84:delegate {57:86:auto i}}`:ssfmt([]string{
		...
		`1120 57:11:conf2 $5 {57:89:delegate {57:90:auto 5}}`:ssfmt([]string{
		...
		`1120 57:11:conf2 $(x) {57:92:delegate {57:94:auto x}}`:ssfmt([]string{
