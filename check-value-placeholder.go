...
var checkpoints_value_placeholder = map[string]map[string]any{
	...
	"check-value-placeholder_test.go": map[string]any{
		...
		`16 3:7:val1 $2 {3:12:delegate {3:13:auto 2}}`:`{3:7:def 2} 2 {3:12 {1:9:word 2}}`,
		`16 3:7:val1 $3 {3:15:delegate {3:16:auto 3}}`:`{3:7:def 3} 3 {3:15 {1:9:word 3}}`,
		`16 3:7:val1 $4 {3:18:delegate {3:19:auto 4}}`:`{3:7:def 4} 4 {3:18 {1:9:word 4}}`,
		`16 3:7:val1 $5 {3:21:delegate {3:22:auto 5}}`:`{3:7:def 5} 5 {3:21 {1:9:word 5}}`,
		`16 3:7:val1 $6 {3:24:delegate {3:25:auto 6}}`:`{3:7:def 6} 6 {3:24 {1:9:word 6}}`,
		`16 3:7:val1 $7 {3:27:delegate {3:28:auto 7}}`:`{3:7:def 7} 7 {3:27 {1:9:word 7}}`,
		`16 3:7:val1 $8 {3:30:delegate {3:31:auto 8}}`:`{3:7:def 8} 8 {3:30 {1:9:word 8}}`,
		`16 3:7:val1 $9 {3:33:delegate {3:34:auto 9}}`:`{3:7:def 9} 9 {3:33 {1:9:word 9}}`,
		`28 4:7:val2 $_ {4:31:delegate {4:32:auto _}}`:[]string{
			`{4:11:def _} a {4:31 {4:19:word a}}`,
			`{4:11:def _} b {4:31 {4:21:word b}}`,
			`{4:11:def _} c {4:31 {4:23:word c}}`,
			`{4:11:def _} d {4:31 {4:25:word d}}`,
			`{4:11:def _} e {4:31 {4:27:word e}}`,
			`{4:11:def _} f {4:31 {4:29:word f}}`,
		},
		...
		`40 5:7:val3 $1 {5:19:delegate {3:10:auto 1}}`:`{5:7:def 1} 1 {5:19 {1:9:word 1}}`,
		`40 5:7:val3 $2 {5:22:delegate {3:13:auto 2}}`:`{5:7:def 2} 2 {5:22 {1:9:word 2}}`,
		`40 5:7:val3 $3 {5:25:delegate {3:16:auto 3}}`:`{5:7:def 3} 3 {5:25 {1:9:word 3}}`,
		`40 5:7:val3 $4 {5:28:delegate {3:19:auto 4}}`:`{5:7:def 4} 4 {5:28 {1:9:word 4}}`,
		`40 5:7:val3 $5 {5:31:delegate {3:22:auto 5}}`:`{5:7:def 5} 5 {5:31 {1:9:word 5}}`,
		`40 5:7:val3 $6 {5:34:delegate {3:25:auto 6}}`:`{5:7:def 6} 6 {5:34 {1:9:word 6}}`,
		`40 5:7:val3 $7 {5:37:delegate {3:28:auto 7}}`:`{5:7:def 7} 7 {5:37 {1:9:word 7}}`,
		`40 5:7:val3 $8 {5:40:delegate {3:31:auto 8}}`:`{5:7:def 8} 8 {5:40 {1:9:word 8}}`,
		`40 5:7:val3 $9 {5:43:delegate {3:34:auto 9}}`:`{5:7:def 9} 9 {5:43 {1:9:word 9}}`,
		`40 5:7:val3 $_ {5:46:delegate {4:32:auto _}}`:[]string{
			`{5:11:def _} 1 {5:46 {5:19 {1:9:word 1}}}`,
			`{5:11:def _} 2 {5:46 {5:22 {1:9:word 2}}}`,
			`{5:11:def _} 3 {5:46 {5:25 {1:9:word 3}}}`,
			`{5:11:def _} 4 {5:46 {5:28 {1:9:word 4}}}`,
			`{5:11:def _} 5 {5:46 {5:31 {1:9:word 5}}}`,
			`{5:11:def _} 6 {5:46 {5:34 {1:9:word 6}}}`,
			`{5:11:def _} 7 {5:46 {5:37 {1:9:word 7}}}`,
			`{5:11:def _} 8 {5:46 {5:40 {1:9:word 8}}}`,
