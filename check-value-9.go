...
var checkpoints_value_9 = map[string]map[string]any{
	...
	"check-value-9_test.go": map[string]any{
		`16 4:9:.test $1 {3:18:delegate {3:19:auto 1}}`:`{3:19:auto 1} .w {3:18 {=compound {4:21:punct .} {4:22 {1:9:word w}}}}`,
		`16 4:9:.test $1 {4:22:delegate {3:19:auto 1}}`:`{3:19:auto 1} w {4:22 {1:9:word w}}`,
		...
		`16 4:9:.test $(.test$1) {3:11:delegate {=compound {3:13:punct .} {3:14:word test} {3:18:delegate {3:19:auto 1}}}}`:`{5:9:def .test.w} foobar {3:11 {5:12:word foobar}}`,
