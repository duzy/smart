...
var checkpoints_value_13 = map[string]map[string]any{
	"loader.go": map[string]any{
		`1120 3:5:foo &(-g!foobar) {3:8:closure {=flag {=compound {3:11:word g} {=negative {3:13:word foobar}}}}}`:`{=flag {=compound {3:11:word g} {=negative {3:13:word foobar}}}} &(-g!foobar) {3:8:closure {=flag {=compound {3:11:word g} {=negative {3:13:word foobar}}}}}`,
	},
