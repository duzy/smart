...
var checkpoints__xor = map[string]map[string]any{
	"loader.go": map[string]any{
		...
		`3:9:val14.1 $(xor {=true},{=true}) {3:12:delegate {3:14:builtin xor} {=list {3:24:true}} {=list {3:33:true}}}`:`{3:14:builtin xor} {} {3:12:null}`,
		`4:9:val14.2 $(xor {=true},{=false}) {4:12:delegate {4:14:builtin xor} {=list {4:24:true}} {=list {4:34:false}}}`:`{4:14:builtin xor} {=true} {4:12 {4:34:true}}`,
		`5:9:val14.3 $(xor {=false},{=true}) {5:12:delegate {5:14:builtin xor} {=list {5:25:false}} {=list {5:33:true}}}`:`{5:14:builtin xor} {=true} {5:12 {5:33:true}}`,
		`6:9:val14.4 $(xor {=false},{=false}) {6:12:delegate {6:14:builtin xor} {=list {6:25:false}} {=list {6:34:false}}}`:`{6:14:builtin xor} {} {6:12:null}`,
	},
