...
var checkpoints_template = map[string]map[string]any{
	"loader.go": map[string]any{
		...
		`9:6:vars $(defs(-capture=1 -sort) {=regex ^var\.([xyz]+)}) {9:9:delegate {9:11:builtin defs} [{=pair {=flag {9:17:word capture}} {9:25:decimal 1}} {=flag {9:28:word sort}}] {=list {9:43:regex ^var\.([xyz]+)}}}`:`xxx yyy zzz {=list {9:9 {9:11:word xxx}} {9:9 {9:11:word yyy}} {9:9 {9:11:word zzz}}}`,
		`10:6:var2 $(defs(-capture=1 -sort) !{=regex ^var\.([xy]+)}) {10:9:delegate {10:11:builtin defs} [{=pair {=flag {10:17:word capture}} {10:25:decimal 1}} {=flag {10:28:word sort}}] {=list {=negative {10:43:regex ^var\.([xy]+)}}}}`:`.self .usee var.zzz var2 vars xyz {=list {10:9 {10:11:word .self}} {10:9 {10:11:word .usee}} {10:9 {10:11:word var.zzz}} {10:9 {10:11:word var2}} {10:9 {10:11:word vars}} {10:9 {10:11:word xyz}}}`,
	},
