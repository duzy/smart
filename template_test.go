...
func testTemplateForeach(ctx *testcase) {
	...
	} else if t.program_[0].depends[1].String() != "$(foreach a d e f,foo=a)" {
		ctx.err("%v: %v", t.target, t.program_[0].depends[1])
	} else if len(t.program_[0].recipes) != 1 {
		ctx.err("%v: %v", t.target, t.program_[0].recipes)
	} else if t.program_[0].recipes[0].String() != "print a $^" {
		ctx.err("%v: %v", t.target, t.program_[0].recipes[0])
	} else if r.String() != ".test.a" {
		ctx.err("%v", ust{r[0]})
	}
	...
	if s := ".test.b"; false {
		...
		ctx.err("%v: %v", t.target, t.program_[0].depends[0])
	} else if t.program_[0].depends[1].String() != "$(foreach b d e f,foo=b)" {
		ctx.err("%v: %v", t.target, t.program_[0].depends[1])
	} else if len(t.program_[0].recipes) != 1 {
		ctx.err("%v: %v", t.target, t.program_[0].recipes)
	} else if t.program_[0].recipes[0].String() != "print b $^" {
		ctx.err("%v: %v", t.target, t.program_[0].recipes[0])
	} else if r.String() != ".test.b" {
		ctx.err("%v", ust{r[0]})
	}
	...
	if s := ".test.c"; false {
		...
		ctx.err("%v: %v", t.target, t.program_[0].depends[0])
	} else if t.program_[0].depends[1].String() != "$(foreach c d e f,foo=c)" {
		ctx.err("%v: %v", t.target, t.program_[0].depends[1])
	} else if len(t.program_[0].recipes) != 1 {
		ctx.err("%v: %v", t.target, t.program_[0].recipes)
	} else if t.program_[0].recipes[0].String() != "print c $^" {
		ctx.err("%v: %v", t.target, t.program_[0].recipes[0])
	} else if r.String() != ".test.c" {
		ctx.err("%v", ust{r[0]})
	}
}
