...
var checkpoints_value_11 = map[string]map[string]any{
	"loader.go": map[string]any{
		...
		`4:10:.test.x $1 {4:20:delegate {3:21:auto 1}}`:`{3:21:auto 1} {} {4:20 {3:21:null}}`,
		...
		`4:10:.test.x &(.test$1) {4:13:closure {=compound {4:15:punct .} {4:16:word test} {4:20:delegate {3:21:auto 1}}}}`:`{=compound {4:15:punct .} {4:16:word test} {4:20 {3:21:null}}} &(.test{}) {4:13:closure {=compound {4:15:punct .} {4:16:word test} {4:20 {3:21:null}}}}`,
		...
		`5:10:.test &(.test{}) {4:13:closure {=compound {4:15:punct .} {4:16:word test} {4:20 {3:21:null}}}}`:`{5:10:def .test} &(.test) {4:13:closure {5:10:def .test}}`,
	...
	"check-value-11_test.go": map[string]any{
		`16 3:11:.test.0 $1 {3:20:delegate {3:21:auto 1}}`:[]string{
			`{3:21:auto 1} {} {3:20 {3:21:null}}`,
			`{3:21:auto 1} {} {4:20 {3:21:null}}`,
		},
		...
		`16 3:11:.test.0 &(.test$1) {3:13:closure {=compound {3:15:punct .} {3:16:word test} {3:20:delegate {3:21:auto 1}}}}`:`{5:10:def .test} {} {3:13 {5:13 {4:13 {5:10:null}}}}`,
		`16 3:11:.test.0 &(.test) {4:13:closure {5:10:def .test}}`:`{5:10:def .test} {} {4:13 {5:10:null}}`,

		`18 3:11:.test.0 $1 {3:20:delegate {3:21:auto 1}}`:`{3:21:auto 1} .s1 {3:20 {1:9:word .s1}}`,
		...
		`18 3:11:.test.0 &(.test$1) {3:13:closure {=compound {3:15:punct .} {3:16:word test} {3:20:delegate {3:21:auto 1}}}}`:`{6:10:def .test.s1} &(.test.s1) {3:13:closure {6:10:def .test.s1}}`,

		`24 3:11:.test.0 $1 {3:20:delegate {3:21:auto 1}}`:`{3:21:auto 1} .s2 {3:20 {1:9:word .s2}}`,
		...
		`24 3:11:.test.0 &(.test$1) {3:13:closure {=compound {3:15:punct .} {3:16:word test} {3:20:delegate {3:21:auto 1}}}}`:`{7:10:def .test.s2} &(.test.s2) {3:13:closure {7:10:def .test.s2}}`,

		`22 3:11:.test.0 &(.test.s1) {3:13:closure {6:10:def .test.s1}}`:`{6:10:def .test.s1} foo {3:13 {6:13:word foo}}`,
		`28 3:11:.test.0 &(.test.s2) {3:13:closure {7:10:def .test.s2}}`:`{7:10:def .test.s2} bar {3:13 {7:13:word bar}}`,

		`30 3:11:.test.0 $1 {3:20:delegate {3:21:auto 1}}`:`{3:21:auto 1} .s1 .s2 {=list {3:20 {1:9:word .s1}} {3:20 {1:9:word .s2}}}`,
		...
		`30 3:11:.test.0 &(.test$1) {3:13:closure {=compound {3:15:punct .} {3:16:word test} {3:20:delegate {3:21:auto 1}}}}`:`{10:16:def .test⌜.s1 .s2⌟} &(.test⌜.s1 .s2⌟) {3:13:closure {10:16:def .test⌜.s1 .s2⌟}}`,
		...
		`34 3:11:.test.0 &(.test⌜.s1 .s2⌟) {3:13:closure {10:16:def .test⌜.s1 .s2⌟}}`:`{10:16:def .test⌜.s1 .s2⌟} foobar {3:13 {10:19:word foobar}}`,

		`43 9:9:.test.1 $1 {9:19:delegate {3:21:auto 1}}`:`{3:21:auto 1} {} {9:19 {3:21:null}}`,
		`43 9:9:.test.1 .test{$1} {=compound {9:13:punct .} {9:14:word test} {9:18:disjunction {9:19:delegate {3:21:auto 1}}}}`:`{} {9:13:null}`,
		`43 9:9:.test.1 &(.test{$1}) {9:11:closure {=compound {9:13:punct .} {9:14:word test} {9:18:disjunction {9:19:delegate {3:21:auto 1}}}}}`:`{9:13:null} {} {9:11:null}`,

		`44 9:9:.test.1 $1 {9:19:delegate {3:21:auto 1}}`:`{3:21:auto 1} {} {9:19 {3:21:null}}`,

		`45 9:9:.test.1 $1 {9:19:delegate {3:21:auto 1}}`:`{3:21:auto 1} .s1 .s2 {=list {9:19 {1:9:word .s1}} {9:19 {1:9:word .s2}}}`,
		...
		`45 9:9:.test.1 &(.test{$1}) {9:11:closure {=compound {9:13:punct .} {9:14:word test} {9:18:disjunction {9:19:delegate {3:21:auto 1}}}}}`:`[{6:10:def .test.s1} {7:10:def .test.s2}] &(.test.s1) &(.test.s2) {=list {9:11:closure {6:10:def .test.s1}} {9:11:closure {7:10:def .test.s2}}}`,

		`49 9:9:.test.1 &(.test.s1) {9:11:closure {6:10:def .test.s1}}`:`{6:10:def .test.s1} foo {9:11 {6:13:word foo}}`,
		`49 9:9:.test.1 &(.test.s2) {9:11:closure {7:10:def .test.s2}}`:`{7:10:def .test.s2} bar {9:11 {7:13:word bar}}`,

		`58 5:10:.test &(.test) {4:13:closure {5:10:def .test}}`:[]string{
